namespace FuzzPhyte.UI.Camera
{
    ...
    /// <summary>
    /// This script was generated and create in an Older Unity Sample Package
    /// Used to be called 'SimpleCameraController' and it's now been embedded in this package
    /// For reference purposes please see the Unity GitHub-->https://github.com/Unity-Technologies/MeasuredMaterialLibraryHDRP/blob/master/Assets/Scripts/SimpleCameraController.cs
    /// </summary>
    public class FPUI_UnityCameraControl : MonoBehaviour
    {
        class CameraState
        {
            public float yaw;
